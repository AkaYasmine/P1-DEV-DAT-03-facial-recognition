                     ...
                     <body class="bg-gray-100">
                        <div class="container mx-auto p-4">
                           ...
                           <div className='containers grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 h-80'>
                              ...
                              <div className="bg-grid  p-6 rounded-lg shadow-md h-100 flex flex-col items-center justify-center">
                                 <h2 className="font-semibold mb-2 text-center text-blue p-2 rounded">Nombres de présences</h2>
                                 <div className="text-4xl font-bold mb-4 text-blue">30</div>
                              </div>
                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-white-400">
                                       ...
                                       <tbody>
                                              <tr class="border-b dark:border-white">
                                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-black">id</th>
                                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-black">  nom </th>
                                                <td class="px-4 py-3"> prenom </td>
                                                <td class="px-4 py-3"> email </td>
  
                                                <td class="px-4 py-3 flex items-center justify-end">
                                             
                                                         <a type="button" data-modal-target="deleteModal" data-modal-toggle="deleteModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-white-100">
