                                       ...
                                       <tbody>
                                          {data.map((d, i) => (
                                             ...
                                             <tr key={i} class="border-b dark:border-white">
                                                ...
                                                <td class="px-4 py-3">{d.prenom}</td>
                                                ...
                                                <td class="px-4 py-3 flex items-center justify-end">
                                                   ...
                                                   {/* <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                                      <li> */}
                                                         <Link to={`/Update_employe/${d.id}`} type="button" data-modal-target="updateProductModal" data-modal-toggle="updateProductModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-blue-950 dark:hover:text-white-400">
                                                      ...
                                                      {/* <li> */}
                                                         <Link onClick={e => handleDelete(d.id)} type="button" data-modal-target="deleteModal" data-modal-toggle="deleteModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 text-red-500 dark:hover:text-white-100">
